...
class _ChatBotState extends State<NewChatBot> {
  ...
  void _connectToServer() {
    ...
    _socket.on("aiMessage", (data) {
      ...
      if (data is List && data.isNotEmpty) {
        ...
        message = "You have reached the limit of messages. Please upgrade your plan to continue using the service or wait for 24 hours";
      } else {
  ...
  void _sendMessage() async {
    if (_controller.text.trim().isEmpty || _chatId == null) {
